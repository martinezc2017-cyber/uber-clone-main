...
async function setupDatabase() {
  ...
  if (existingDrivers[0].count === '0' || existingDrivers[0].count === 0) {
    ...
    console.log('Drivers already exist, skipping insertion.');
  }
  ...
  await sql`CREATE INDEX IF NOT EXISTS idx_rides_created_at ON rides(created_at DESC)`;
